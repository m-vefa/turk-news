package com.newsapp.user.security.jwt;

import static com.newsapp.user.security.AuthoritiesConstants.ADMIN;
import static com.newsapp.user.security.SecurityUtils.AUTHORITIES_CLAIM;
import static com.newsapp.user.security.SecurityUtils.JWT_ALGORITHM;
